...
class Custom_JSON_Encoder(json.JSONEncoder):
    """
    Custom JSON Encoder to store Enum and custom configuration sample (for example) of the framework
    """
    ...
    def default(self, o):
        ...
        if isinstance(o, pathlib.Path):
            return str(o)
        if isinstance(o, utils.JSON_parsable_Enum):
            # If this is an object flagger as String equivalent, parse it as a String
            return str(o)
        if isinstance(o, utils.JSON_parsable_Dict):
